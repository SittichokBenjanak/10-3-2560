...
public class ConfirmOrderActivity extends AppCompatActivity {
    ...
    public void clickFinish(View view) {
        ...
        if (totalAnInt > intBalane) {
            ...
            objIntent.putExtra("idOrder", strOrderNumber);
            objIntent.putExtra("dateorder", dateString);
            objIntent.putExtra("name",nameString);
            objIntent.putExtra("surname", surnameString);
            objIntent.putExtra("total", strSumprice);
            startActivity(objIntent);
    ...
    private void showView() {
        ...
        strSumprice = objNumberFormat.format(intsum);
